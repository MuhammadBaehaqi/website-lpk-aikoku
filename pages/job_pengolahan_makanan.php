...
$query = mysqli_query($mysqli, "SELECT * FROM tb_job WHERE nama_job = 'Pengolahan Makanan' LIMIT 1");
$data = mysqli_fetch_assoc($query);
//ini buat detail 
$detail = mysqli_query($mysqli, "SELECT * FROM tb_job_detail WHERE nama_job = 'Pengolahan Makanan' LIMIT 1");
...
<head>
    <meta charset="UTF-8">
    <title>Bidang Pekerjaan - Pengolahan Makanan</title>
