...
<body>
    ...
    <div class="content">
        ...
        <div class="card mb-4">
            ...
            <div class="card-body">
                <form action="proses_tambah_hero_profile.php" method="POST" enctype="multipart/form-data">
                    ...
                    <?php while ($row = mysqli_fetch_assoc($pengurus_result)) : ?>
                        <tr>
                            ...
                            <td>
                                ...
                                <a href="hapus_pengurus.php?id=<?= $row['id_pengurus']; ?>" onclick="return confirm('Yakin ingin menghapus data ini?')"
                        ...
                        <div class="modal fade" id="editModal<?= $row['id_pengurus']; ?>" tabindex="-1" aria-labelledby="editModalLabel<?= $row['id_pengurus']; ?>" aria-hidden="true">
                            <div class="modal-dialog modal-lg modal-dialog-centered">
                                <div class="modal-content">
                                    <form action="update_pengurus.php" method="POST" enctype="multipart/form-data">
...
<div class="modal fade" id="editModal<?= $row['id_legalitas']; ?>" tabindex="-1"
                            ...
                            <div class="modal-dialog modal-lg">
                                <div class="modal-content">
                                    <form action="proses_edit_legalitas.php" method="POST" enctype="multipart/form-data">
                                        <div class="modal-header">
...
<div class="modal fade" id="hapusModal<?= $row['id_legalitas']; ?>" tabindex="-1" aria-labelledby="hapusModalLabel<?= $row['id_legalitas']; ?>" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
      <form action="hapus_legalitas.php" method="GET">
        <div class="modal-header">
